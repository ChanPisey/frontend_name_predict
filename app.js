...
async function render() {
  ...
  try {
    ...
    genderSpan.style.color      = isMale ? '#2563eb' : '#db2777';
    genderSpan.style.fontWeight = '900';
    genderSpan.textContent      = isMale ? '♂ ប្រុស' : '♀ ស្រី';
    resultTitle.appendChild(genderSpan);
    resultTitle.appendChild(document.createTextNode(` — "${token}"`));
